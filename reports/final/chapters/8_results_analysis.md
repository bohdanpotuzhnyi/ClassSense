...
![Mean and STD for usability (A = buttons, B = sliders).](../images/mean-std-usability-student.png)
...
![Mean and STD for disruption (A = buttons, B = sliders).](../images/mean-std-disruption-student.png)
...
![Mean and STD for adoption intention (A = buttons, B = sliders).](../images/mean-std-adoption-student.png)
...
![Mean and STD for reaction time (A = buttons, B = sliders).](../images/mean-std-reaction-student.png)
...
![Mean and STD for usability (A = browser, B = external screen).](../images/mean-std-usability-teacher.png)
...
![Mean and STD for disruption/practicality (A = browser, B = external screen).](../images/mean-std-disruption-teacher.png)
...
![Mean and STD for adoption intention (A = browser, B = external screen).](../images/mean-std-adoption-teacher.png)
